...
disable_dm = False     #  --disable-dm     
rf_n_jobs = 1           #  --rf-n-jobs 1   
cv_n_jobs = 1           #  --cv-n-jobs 1     
only_node = None       #  --only-node "Haematological malignancy"   
...
SRC_DIR = "/Workspace/Users/ycui@ccia.org.au/test_branch/working_branch_copy/src"
print("src list:", os.listdir(SRC_DIR))

# COMMAND ----------

sys.path.append(r"/Workspace/Users/ycui@ccia.org.au/test_branch/working_branch_copy/src")
